              ...
              {mappedAttributes.map((attribute, idx, arr) => (
                ...
                >
                  <a
                    ...
                    className="flex transform-gpu flex-col border border-[#D4D4D4] bg-white p-3 transition ease-in hover:-translate-y-0.5 hover:scale-[1.01] hover:shadow-lg hover:ease-out dark:border-neutral-800 dark:bg-black dark:hover:border-neutral-600 lg:p-6"
                  >
